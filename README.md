...
### 🌊 Optional Wave ASCII (Alternative for Neofetch icon)

If you want to swap out the character icon inside the Neofetch terminal block, here is Hokusai's *The Great Wave off Kanagawa* in high-contrast text ASCII format:
